...
✍️ To view the emojis I can use, simply type /reactions. For my Leak MMS or Other Adult Content [Click here](https://telegram.me/BhaiLinksDeBot).
...
<button class="button githubBtn" onclick="window.location='https://github.com/LimbuSoda/Auto-Reaction-Bot10'">Open Source 🌱</button>

<div style="margin: 5px;">
  <a class="github-button" href="https://github.com/LimbuSoda/Auto-Reaction-Bot10" data-size="large" data-show-count="true">Star</a>
  <a class="github-button" href="https://github.com/LimbuSoda/Auto-Reaction-Bot10/fork" data-size="large" data-show-count="true">Fork</a>
</div>
<div>
  <a class="github-button" href="https://github.com/LimbuSoda" data-size="large">Follow @LimbuSoda</a>
</div>
</body>
</html>
`;
